...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        if sentence_length > max_length:
            ...
            ret.append((sentence + [zero_vector] * (max_length - sentence_length), labels + [zero_label] * (max_length - sentence_length), [True] * sentence_length + [False] * (max_length - sentence_length)))
        else:
            ret.append((sentence, labels, [True] * sentence_length))
        ### END YOUR CODE ###
    return ret
...
class RNNModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        h = tf.zeros([input_shape[0],self.config.hidden_size])
        ### END YOUR CODE
