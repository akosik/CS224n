...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(tf.int32, shape=(None,self.config.n_features), name='x')
        self.labels_placeholder = tf.placeholder(tf.float32, shape=(None,self.config.n_classes), name='y')
    ...
    def add_prediction_op(self):
        ...
        tf.add_to_collection("Ureg",tf.nn.l2_loss(U))
        tf.add_to_collection("Wreg",tf.nn.l2_loss(W))
    ...
    def add_loss_op(self, pred):
        ...
        loss += tf.reduce_sum(tf.get_collection("Ureg") + tf.get_collection("Wreg")) * self.config.l2lambda / 2
        ### END YOUR CODE
        return loss
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        train_op = tf.train.AdamOptimizer(learning_rate=self.config.lr,beta1=.9,beta2=.999).minimize(loss)
        ### END YOUR CODE
        return train_op
